...
# # checkpoint
# ckpt = "model_{epoch:02d}-{val_loss}.hdf5"
# checkpoint = ModelCheckpoint(os.path.join('./checkpoint', ckpt), monitor='loss', save_weights_only=False, verbose=1, save_best_only=True)
